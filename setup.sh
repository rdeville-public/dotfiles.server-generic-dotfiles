...
declare -A LINKS
LINKS["${CONFIG_DIR}/htop"]="${SCRIPTPATH}/htop"
LINKS["${CONFIG_DIR}/neofetch"]="${SCRIPTPATH}/neofetch"
LINKS["${CONFIG_DIR}/user-dirs.conf"]="${SCRIPTPATH}/user-dirs.conf"
LINKS["${CONFIG_DIR}/user-dirs.dirs"]="${SCRIPTPATH}/user-dirs.dirs"
LINKS["${CONFIG_DIR}/user-dirs.locale"]="${SCRIPTPATH}/user-dirs.locale"
